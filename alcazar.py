...
def get_secrets_on_startup():
    ...
    try:
        ...
        # TODO: Figure out why these aren't equal
        print(secrets['master_password'])
        print(b64encode(encrpyted_user_pass).decode('utf-8'))
...
def retrieve_secret(secrets, secret_name, fernet_session):
    ...
    return b64encode(fernet_session.decrypt(bytes(secret_value, 'utf-8'))).decode('utf-8')
